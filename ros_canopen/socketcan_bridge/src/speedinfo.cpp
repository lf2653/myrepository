   ...
   SpeedinfoNode::SpeedinfoNode()
      {
         ...
         sub_ = n_.subscribe("/control/arduino_output_throttle", 10, &SpeedinfoNode::callback, this);
      }

   void SpeedinfoNode::callback(const geometry_msgs::Point32 & input)
      {
   ...
   YawinfoNode::YawinfoNode()
      {
         ...
         //Topic you want to subscribe
         sub_ = n_.subscribe("/control/arduino_output_steering", 10, &YawinfoNode::callback, this);
      }

   void YawinfoNode::callback(const geometry_msgs::Point32 & input)
      {
         can_msgs::Frame output;
            //.... do something with the input and generate the output...
